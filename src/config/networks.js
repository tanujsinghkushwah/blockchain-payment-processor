...
/**
 * Get network configurations with current environment variables
...
// Export both the function and a cached version of the config
module.exports = getNetworkConfigs;
module.exports.configs = getNetworkConfigs();
